...
public class SanSchool extends Activity {
    ...
    class MyThread extends Thread{
        public void run(){
            ...
            try{
                ...
                String parameter = "act=arrbus&winc_id=05207";
    ...
    class MyHandler extends Handler{
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            ArrInfoAdapter adapter = new ArrInfoAdapter(SanSchool.this, total_arrinfo);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(SanSchool.this, MainActivity.class);
                startActivity(i);
            }
        });
